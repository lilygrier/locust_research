...
def wrapper():
    '''
    Wrapper function for web scraping. Downloads all locust bulletin files to machine.
    '''
...
def get_pdfs(to_visit):
    '''
    Takes in dictionary of urls to visit and downloads pdfs.
    Inputs:
        to_visit: dictionary of years and urls
    '''
